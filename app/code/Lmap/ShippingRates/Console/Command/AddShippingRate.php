...
class AddShippingRate extends Command
{
    ...
    public function __construct(ShippingRatesFactory $rateFactory, LoggerInterface $logger)
    ...
    {
        $this->setName('lmap:shippingrate:add')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $item->save();
        $this->logger->debug('New Shipping Rate Entered'); //refers to code in di.xml file from line 13 to line 57.
