...
namespace Lmap\ShippingRates\Console\Command;
...
use Lmap\ShippingRates\Model\ResourceModel\ShippingRates\CollectionFactory;
use Magento\Framework\Console\Cli;




class DeleteShippingRate extends Command
{
    ...
    public function __construct(ShippingRatesFactory $rateFactory, CollectionFactory $collectionFactory,LoggerInterface $logger)
    {
    ...
    {
        $this->setName('lmap:shippingrate:delete')
