...
namespace Lmap\ShippingRates\Model;
...
class ShippingRates extends AbstractModel
{
    protected $_eventPrefix = 'shipping_rates_event';// This even prefix will be used for coding event (observer) based logging latter on.
    // This prefix is used by AbstractModel to generate events.
    protected function _construct()
    {
        //$this->_init(EquipmentItem::class);
        $this->_init(\Lmap\ShippingRates\Model\ResourceModel\ShippingRates::class);
        /*
